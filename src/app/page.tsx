...
export default async function HomePage() {
  ...
  const [heroData, latestNewsData, eventsData, galleryData] = await Promise.all(
    [getHomeHero(), getHomeNews(3), getHomeEvents(4), getHomeGallery(8)],
  );
                  ...
                  <div key={event.id} className="card p-6 flex gap-6">
                    <div className="flex-shrink-0 w-20 text-center">
                      <div className="bg-burgundy-100 dark:bg-burgundy-900/50 rounded-lg py-3">
                        <span className="block text-3xl font-bold text-burgundy-700 dark:text-burgundy-400">
                          {eventDate.getDate()}
                        </span>
                    ...
                    <div>
                      ...
                      <p className="text-mountain-600 dark:text-mountain-300 text-sm font-[Georgia,'Times_New_Roman',Times,serif]">
                        {event.description}
                      </p>
