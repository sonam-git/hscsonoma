...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the Himalayan Sherpa Club of Sonoma, our mission to preserve Sherpa culture, and our journey from the Himalayan peaks to the vineyards of Sonoma.",
};
    ...
    <>
      ...
      <section className="relative pt-40 pb-32 lg:pt-44 bg-gradient-himalayan">
        <div className="relative container-custom text-center">
          <p className="font-tibetan text-xl text-gold-400 mb-4">
          ...
          <p className="text-xl text-cream-200 max-w-2xl mx-auto">
            From the peaks of the Himalayas to the vineyards of Sonoma, discover
            ...
            <div>
              ...
              <div className="space-y-6 text-mountain-600 dark:text-mountain-300">
                <p className="text-md leading-relaxed">
                  The Himalayan Sherpa Club was established as a non-profit,
                ...
                <p className="leading-relaxed">
                  We actively encourage participation from individuals of all
                  ages and professional backgrounds, with a special focus on
                  engaging younger generations in community activities. By
                  creating opportunities for cultural exchange and
                  knowledge-sharing, we strive to ensure that our rich
                  traditions are passed down to future generations.
                </p>

                <p className="leading-relaxed">
                  We warmly welcome anyone who shares our vision to join us in
                  celebrating and preserving the Sherpa heritage.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8 text-mountain-600 dark:text-mountain-300 text-lg leading-relaxed">
              <p>
                The story of the Himalayan Sherpa Club is deeply rooted in the
                resilience and adaptability of the Sherpa people. For
                generations, Sherpas lived a humble life in the high Himalayas,
                farming potatoes, buckwheat, and turnips, and engaging in trade
                with Tibetan merchants. However, in 1953, the historic ascent of
                Mt. Everest by Sir Edmund Hillary and Tenzing Norgay Sherpa
                changed everything. The world took notice of the Sherpas&apos;
                extraordinary mountaineering skills, and soon, the tourism and
                climbing industry flourished in Nepal.
              </p>

              <p>
                With this new livelihood, the Sherpas developed strong
                connections with Western climbers, including Americans. Over
                time, these relationships opened up opportunities for Sherpas to
                move abroad. While working as a trekking guide in Nepal,
                Chhiring Sherpa met some American friends who invited him to
                Sonoma in the early 1990s. A few years later, Ongda Sherpa and
                Nima Sherpa, friends of Chhiring from Nepal who had been living
                in Colorado, also moved to Sonoma. The three initially settled
                in Glen Ellen and are considered the first Sherpas to establish
                roots in Sonoma. Gradually, more Sherpa families joined them,
                establishing a growing and close-knit community in Sonoma.
              </p>

              <p>
                At first, the community was small, celebrating their traditions
                quietly in homes and apartments. As the years passed and more
                families arrived, they began to recognize the need for a unified
                community group. Around 2004–2005, they started planning to
                create a club and named it the Himalayan Sherpa Club, as most
                members were from the Sherpa community and the Himalayan region
              ...
              <p>
                What started as a small gathering of families has now flourished
                into a vibrant community of over 30 Sherpa families in Sonoma.
                Through cultural events, celebrations, and educational
                initiatives, the club continues to honor the traditions of the
                Himalayas while embracing life in their new home. The spirit of
                the Sherpa people—resilient, welcoming, and deeply rooted in
                culture—lives on in Sonoma, keeping the bond between the
                Himalayas and California as strong as ever.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            {[
              ...
              <div
                key={index}
                className="bg-white dark:bg-mountain-800 rounded-xl p-6 shadow-lg"
              >
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-cream-200 leading-relaxed">
              Our mission is to preserve and promote Sherpa culture while
              fostering a united and thriving community in the North Bay Area.
              We are committed to celebrating our unique and rich cultural
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                description:
                  "Being part of the Sonoma Community ever since its establishment, contributing to local events and initiatives.",
              },
            ].map((objective, index) => (
              <div
                key={index}
                className="bg-white dark:bg-mountain-800 rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl dark:shadow-mountain-950/50 transition-shadow"
              >
                <div className="w-10 h-10 md:w-14 md:h-14 bg-burgundy-100 dark:bg-burgundy-900/50 rounded-xl flex items-center justify-center mb-3 md:mb-4">
                  <svg
                    className="w-5 h-5 md:w-7 md:h-7 text-burgundy-700 dark:text-burgundy-400"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <h3 className="text-sm md:text-lg font-semibold text-mountain-900 dark:text-cream-50 mb-1 md:mb-2">
                  {objective.title}
                </h3>
                <p className="text-mountain-600 dark:text-mountain-300 text-xs md:text-sm">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-mountain-600 dark:text-mountain-300">
                Explore our history, culture, and the families that built our
                community.
              </p>
            </div>
