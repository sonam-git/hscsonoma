...
const hardcodedGalleryImages: GalleryImage[] = [
  ...
  },
  {
    ...
    alt: "HSC Gathering",
    caption:
      "HSC members perfroming traditional Sherpa dance during Losar Celebration",
    category: "Cultural",
  },
  {
    src: "/images/hsc/hsc-board-2018.jpg",
    alt: "HSC Board Members 2018",
    caption: "HSC Board Members 2018",
    category: "Community",
  },
  {
    ...
    caption:
      "HSC Member Pasang Nuru participating in Napa - Sonoma Marathon 2017",
    category: "Sports",
  },
  {
    src: "/images/hsc/hsc-newyear-celebration-2013.jpg",
    alt: "HSC New Year Celebration 2013",
    caption: "HSC New Year Celebration 2013",
    category: "Cultural",
  },
  {
...
export default function GalleryPage() {
  ...
  const getFilteredImages = (): GalleryImage[] => {
    if (activeFilter === "New") {
      ...
      return hardcodedGalleryImages.filter(
  ...
  const renderEmptyState = () => (
    <div className="text-center py-16">
      <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-burgundy-100 dark:bg-burgundy-900/30 mb-4">
        <svg
          className="w-8 h-8 text-burgundy-600 dark:text-burgundy-400"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <p className="text-mountain-600 dark:text-mountain-400 max-w-md mx-auto">
        Check back soon for the latest photos from our community events and
        celebrations.
      </p>
    </div>
  );
    ...
    <main className="min-h-screen bg-cream-50 dark:bg-mountain-950">
      ...
      <section className="relative pt-40 pb-32 lg:pt-44 bg-gradient-himalayan">
        ...
        <div className="absolute inset-x-0 bottom-0 h-16">
          ...
          >
            <path
              className="fill-cream-50 dark:fill-mountain-950"
      ...
      <section
        ref={contentRef}
        className="py-16 scroll-mt-[200px] xl:scroll-mt-[200px]"
      >
                ...
                >
                  <Image
                    src={
                      ...
                      hardcodedGalleryImages[0].src
                    }
                    alt={
                      filteredImages[currentIndex]?.alt ||
                      hardcodedGalleryImages[0].alt
                    }
                    fill
